...
class Boutique(models.Model):
    ...
    responsable = models.ForeignKey('free_app.UserProfile', on_delete=models.SET_NULL, null=True, blank=True, related_name='boutiques_responsable')  # Responsable principal
